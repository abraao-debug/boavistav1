"""
Django settings for gestao_obra project.
...
WSGI_APPLICATION = 'gestao_obra.wsgi.application'
...
LOGIN_URL = 'materiais:login'  
LOGIN_REDIRECT_URL = 'materiais:dashboard'  
LOGOUT_REDIRECT_URL = 'materiais:login'
